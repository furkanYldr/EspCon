...
STRUCTGHOST blinky = { 77, 137, 0, 0, false, false, false, false, BlinkyColor, 0, 0, SCATTER, GEMPTY };
STRUCTGHOST inky = { 90, 155, 0, 0, false, false, false, false, InkyColor, 0, 0, SCATTER, GEMPTY };
STRUCTGHOST clyde = { 70, 155, 0, 0, false, false, false, false, ClydeColor, 0, 0, SCATTER, GEMPTY };
STRUCTGHOST pinky = { 80, 155, 0, 0, false, false, false, false, PinkyColor, 0, 0, SCATTER, GEMPTY };



vector<STRUCTGHOST> vecGHOST = { blinky, pinky, inky, clyde };
...
void spawnGhost() {
  ...
  if (timer > prevTimer && pinkyTimer <= 8) {
